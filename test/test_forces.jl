...
let
    ...
    epts = SVec.(x, y, 0.0); Ne = length(epts)
    ipts = SVec.([(0.2,0.5,0.0), (0.8,0.5,0.0)]); Ni = length(ipts)
    
    tri = [Tri((0.,0,0), (1.,0,0), (1.,1,0)),
    ...
    epts = SVec.(x, 0.0, y); Ne = length(epts)
    ipts = SVec.([(0.2,0.0,0.0), (0.8,0.0,0.0)]); Ni = length(ipts)
    
    tri = [Tri((0.,0,0), (1.,0,0), (1.,0,1)),
    ...
    # Let's get the faces:
    tri = [Tri((-4.,-4,0),(4.,-4,0),(4.,-4,16)), # F1
           Tri((-4.,-4,0),(4.,-4,16),(-4.,-4,16)), # F1
           Tri((4.,-4,0),(4.,4,0),(4.,4,16)), # F2
           Tri((4.,-4,0),(4.,4,16),(4.,-4,16)), # F2
           Tri((4.,4,0),(-4.,4,0),(-4.,4,16)), # F3
           Tri((4.,4,0),(-4.,4,16),(4.,4,16)), # F3
           Tri((-4.,4,0),(-4.,-4,0),(-4.,-4,16)), # F4
           Tri((-4.,4,0),(-4.,-4,16),(-4.,4,16))] # F4
